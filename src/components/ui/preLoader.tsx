  ...
  return (
    <div className="h-screen overflow-hidden bg-black text-white flex flex-col items-center justify-center">
      <div>
        ...
        <div className="relative -mt-32 h-40 w-screen overflow-hidden [mask-image:radial-gradient(circle closest-side at 50% 50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle closest-side at bottom center,#3273ff,transparent_90%)] before:opacity-40 after:absolute after:-left-1/2 after:top-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[10%] after:border-t after:border-[#163474] after:bg-[#08132b]">
          <Sparkles
            density={400}
            size={1.4}
            direction="top"
            className="absolute inset-x-0 top-0 h-full w-full [mask-image:radial-gradient(circle closest-side at 50% 50%,white,transparent_85%)]"
          />
        </div>
      </div>
    </div>
